...
**     Version     : Component 01.168, Driver 01.10, CPU db: 3.00.001
...
static AS1_TDeviceDataPtr INT_UART3_RX_TX__DEFAULT_RTOS_ISRPARAM;
/* {Default RTOS Adapter} Global variable used for passing a parameter into ISR */
static AS1_TDeviceDataPtr INT_UART3_ERR__DEFAULT_RTOS_ISRPARAM;
...
PE_ISR(AS1_Interrupt)
{
  ...
  AS1_TDeviceDataPtr DeviceDataPrv = INT_UART3_RX_TX__DEFAULT_RTOS_ISRPARAM;
